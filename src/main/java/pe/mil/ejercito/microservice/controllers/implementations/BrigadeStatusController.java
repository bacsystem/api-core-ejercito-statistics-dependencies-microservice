...
import pe.mil.ejercito.microservice.controllers.contracts.IBrigadeStatusController;
...
/**
 * BrigadeStatusController
 * <p>
 * BrigadeStatusController class.
 * <p>
...
public class BrigadeStatusController extends ReactorControllerBase implements IBrigadeStatusController {

    private final IBrigadeStatusDomainService service;

    public BrigadeStatusController(final Response response, IBrigadeStatusDomainService service) {
        super(response, "BrigadeStatusController");

        this.service = service;
    }

    @Override
    @GetMapping(path = FIND_ALL_BRIGADE_STATUS_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @Override
    @GetMapping(path = FIND_BY_ID_BRIGADE_STATUS_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @Override
    @GetMapping(path = FIND_BY_UUID_BRIGADE_STATUS_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @Override
    @PostMapping(path = CREATE_BRIGADE_STATUS_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
    public Mono<ResponseEntity<Object>> doOnCreateExecute(@RequestBody @Valid BrigadeStatusDto dto) {
    ...
    @Override
    @PutMapping(path = UPDATE_BRIGADE_STATUS_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
    public Mono<ResponseEntity<Object>> doOnUpdateExecute(@RequestBody @Valid BrigadeStatusDto dto) {
    ...
    @Override
    @DeleteMapping(path = DELETE_BRIGADE_STATUS_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
