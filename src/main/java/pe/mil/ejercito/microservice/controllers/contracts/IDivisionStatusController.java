...
/**
 * IDivisionStatusController
 * <p>
 * IDivisionStatusController interface.
 * <p>
 ...
 * @since 25/02/2024
 */
public interface IDivisionStatusController {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(schema = @Schema(implementation = DivisionStatusDto.class))),
            @ApiResponse(
                    responseCode = "200",
                    description = "Successful operation",
    ...
    Mono<ResponseEntity<Object>> doOnCreateExecute(DivisionStatusDto dto);
    ...
    Mono<ResponseEntity<Object>> doOnUpdateExecute(DivisionStatusDto dto);
